...
⚠️ Note: Do not use or commit real credentials in this repository
The original exposed SMTP credentials have been removed for security reasons
Users must configure their own Gmail account for the feature to work
